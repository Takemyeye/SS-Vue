...
passport.use(new GoogleStrategy({
  ...
  callbackURL: 'https://soulswap.store /api/auth/google/callback',
...
passport.use(new GitHubStrategy({
  ...
  callbackURL: 'https://soulswap.store /api/auth/github/callback',
  scope: ['user:email'] 
},
async (accessToken, refreshToken, profile, done) => {
  try {
...
passport.use(new DiscordStrategy({
  ...
  callbackURL: 'https://soulswap.store /api/auth/discord/callback',
