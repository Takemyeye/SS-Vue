...
passport.use(new GoogleStrategy({
  ...
  callbackURL: 'https://soulswap.store/auth/google/callback',
...
passport.use(new GitHubStrategy({
  ...
  callbackURL: 'https://soulswap.store/auth/github/callback',
  scope: ['user:email'] 
},
async (accessToken, refreshToken, profile, done) => {
  try {
...
passport.use(new DiscordStrategy({
  ...
  callbackURL: 'https://soulswap.store/auth/discord/callback',
