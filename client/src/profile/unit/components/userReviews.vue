...
export default {
  ...
  setup() {
    ...
    const fetchReviews = async () => {
      try {
        const response = await fetch(`https://ss-vue-yf04.onrender.com/api/reviews/${token}`);
    ...
    const deleteReview = async (reviewId) => {
      try {
        const response = await fetch(`https://ss-vue-yf04.onrender.com/api/reviews/${reviewId}`, {
          method: 'DELETE',
          headers: {
